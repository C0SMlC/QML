...
0xbc,0x19,0x0,0x0,0x32,0x36,0x34,0x31,
...
// generate_GetLookup
while (!aotContext->getValueLookup(4, r2_0.data(), &r2_1)) {
...
r12_0 = std::move(r2_1);
// generate_LoadQmlContextPropertyLookup
r2_0 = QVariant(aotContext->lookupResultMetaType(9));
while (!aotContext->loadScopeObjectPropertyLookup(9, r2_0.data())) {
aotContext->setInstructionPointer(15);
aotContext->initLoadScopeObjectPropertyLookup(9, r2_0.metaType());
if (aotContext->engine->hasError())
    return double();
r2_0 = QVariant(aotContext->lookupResultMetaType(9));
}
// generate_GetLookup
while (!aotContext->getValueLookup(10, r2_0.data(), &r2_1)) {
aotContext->setInstructionPointer(17);
...
// generate_GetLookup
while (!aotContext->getObjectLookup(34, r2_0, &r2_2)) {
aotContext->setInstructionPointer(10);
...
// generate_GetLookup
while (!aotContext->getObjectLookup(36, r2_0, &r2_2)) {
...
r2_2 = double(2);
// generate_Mul
r2_2 = (std::move(r9_0) * std::move(r2_2));
// generate_Sub
r2_2 = (std::move(r8_0) - std::move(r2_2));
// generate_Sub
r2_2 = (r7_0 - std::move(r2_2));
// generate_Ret
return r2_2;
});}
...
{
int retrieved;
while (!aotContext->getObjectLookup(50, r2_0, &retrieved)) {
aotContext->setInstructionPointer(10);
...
// generate_GetLookup
while (!aotContext->getObjectLookup(56, r2_0, &r2_2)) {
aotContext->setInstructionPointer(16);
...
// generate_GetLookup
while (!aotContext->getObjectLookup(58, r2_0, &r2_2)) {
aotContext->setInstructionPointer(22);
...
while (!aotContext->getObjectLookup(66, r2_0, retrieved.data())) {
aotContext->setInstructionPointer(13);
aotContext->initGetObjectLookup(66, r2_0, retrieved.metaType());
if (aotContext->engine->hasError())
    return QVariant();
retrieved = QVariant(aotContext->lookupResultMetaType(66));
}
...
while (!aotContext->getObjectLookup(70, r2_0, retrieved.data())) {
aotContext->setInstructionPointer(10);
aotContext->initGetObjectLookup(70, r2_0, retrieved.metaType());
if (aotContext->engine->hasError())
    return QVariant();
retrieved = QVariant(aotContext->lookupResultMetaType(70));
}
